    ...
    <section className="p-3 flex flex-col overflow-hidden bg-white" style={{ width: `${rightPanelWidth}%` }}>
      ...
      {showClearConfirm && (
        ...
        >
          ...
          >
            <h3 className="text-lg font-semibold text-slate-900 mb-2">Clear all chat messages?</h3>
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                className="px-4 py-2 text-sm bg-red-600 hover:bg-red-700 text-white rounded shadow-sm transition-colors"
              >
                Clear
              </button>
            </div>
